# Resultados de validação — etapas 1 a 6
...
- A calibração acústica precisa ser repetida e comparada com referência externa em cada
  aparelho/rota; confiança alta do estimador não substitui essa validação física.
